...
<head>
    ...
    <script>
        ...
        // Xác nhận tham gia và hiển thị lời cảm ơn
        function confirmParticipation() {
            // Ẩn thẻ mời và đếm ngược
            ...
            sendTelegramMessage(getGuestName() + " đã xác nhận tham gia buổi tiệc tốt nghiệp!");
        }

        // Bắt đầu trò chơi đoán số khi nhấn OK
        function startGuessGame() {
            // Ẩn lời cảm ơn và hiển thị trò chơi đoán số
...
<body>
    ...
    <div id="invitation-card" class="card">
        ...
        <button class="btn" onclick="confirmParticipation()">✅ Xác nhận tham gia</button>
    </div>
